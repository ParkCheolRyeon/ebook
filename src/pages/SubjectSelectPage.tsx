...
const subjects: SubjectCard[] = [
  ...
  { key: "react", label: "React", description: "컴포넌트 기반 UI 라이브러리", icon: "⚛️", available: false },
  { key: "next", label: "Next.js", description: "풀스택 React 프레임워크", icon: "▲", available: false },
  { key: "typescript", label: "TypeScript", description: "타입 시스템과 고급 패턴", icon: "🔷", available: false },
